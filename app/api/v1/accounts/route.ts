...
//
// "Issued for a user" is `userId`, NOT `currentActor` — see
// `AuthenticatedAppApiHandle`'s `userId` field for why the two disagree. Read
// as an app token, such a user could mint accounts.
