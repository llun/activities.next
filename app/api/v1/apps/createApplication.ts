...
// consumption). @better-auth/core is a direct, exact-pinned dependency, so this
// resolves under strict package managers (this repo uses Yarn 4) and can't
// drift on a minor/patch bump. We deliberately reuse it rather than
