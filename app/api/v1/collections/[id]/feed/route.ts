    ...
    timelineErrorBoundary(
      ...
      async (req, { database, currentActor, params }) => {
        ...
        const nextLink = nextCursor
          ? `<https://${host}/api/v1/collections/${id}/feed?limit=${limit}&max_id=${nextCursor}>; rel="next"`
          : null
        const prevLink = prevCursor
          ? `<https://${host}/api/v1/collections/${id}/feed?limit=${limit}&min_id=${prevCursor}>; rel="prev"`
          : null
