      ...
      >
        ...
        >
          <div className="flex min-h-14 items-center justify-between gap-3 border-b px-4 md:min-h-16 md:px-5">
            <div className="skeleton size-9 shrink-0 rounded-md md:hidden" />
            <div className="skeleton size-9 shrink-0 rounded-full" />
            <div className="min-w-0 flex-1 space-y-1">
              <div className="skeleton h-5 w-32 rounded md:h-6 md:w-40" />
              <div className="skeleton h-3.5 w-20 rounded md:w-28" />
            </div>
          ...
          <div
            ...
            className="min-h-0 min-w-0 flex-1 space-y-3 overflow-y-auto px-4 py-4 md:px-6"
          >
