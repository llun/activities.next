...
describe('agents oxlint plugin', () => {
  ...
  it('flags every spelling of a path builder in a local storage driver', () => {
    const driver = [
      ...
      'type GenericResolver = <T extends string>(...args: string[]) => string',
      '',
      'export class Driver {',
      ...
      '  }',
      '',
      '  // A bare generic instantiation — TS2635 in that form, TS2558 once you',
      '  // add call parens, which is a different node; see TRANSPARENT_WRAPPERS.',
      ...
      '  instantiated(filePath: string) {',
      '    const build = (path.resolve as unknown as GenericResolver)<string>',
      '    return build(this._config.path, filePath)',
      '  }',
      '',
    ...
    expect(
      ...
      'lib/services/fitness-files/localFile.ts:12 agents(no-storage-path-builder)',
      'lib/services/fitness-files/localFile.ts:16 agents(no-storage-path-builder)',
      'lib/services/fitness-files/localFile.ts:20 agents(no-storage-path-builder)',
      'lib/services/fitness-files/localFile.ts:24 agents(no-storage-path-builder)',
      'lib/services/fitness-files/localFile.ts:28 agents(no-storage-path-builder)',
      ...
      'lib/services/fitness-files/localFile.ts:61 agents(no-storage-path-builder)',
      'lib/services/fitness-files/localFile.ts:65 agents(no-storage-path-builder)',
      'lib/services/fitness-files/localFile.ts:69 agents(no-storage-path-builder)',
      'lib/services/fitness-files/localFile.ts:73 agents(no-storage-path-builder)',
      ...
      'lib/services/medias/localFile.ts:24 agents(no-storage-path-builder)',
      'lib/services/medias/localFile.ts:28 agents(no-storage-path-builder)',
      ...
      'lib/services/medias/localFile.ts:61 agents(no-storage-path-builder)',
      'lib/services/medias/localFile.ts:65 agents(no-storage-path-builder)',
      'lib/services/medias/localFile.ts:69 agents(no-storage-path-builder)',
      'lib/services/medias/localFile.ts:73 agents(no-storage-path-builder)'
    ])
  })
