...
export const ContentWarning: FC<Props> = ({
  ...
  return (
    <div className="mt-2 rounded-md border border-border/70 bg-muted/30 px-3 py-2 [--post-media-bleed-left:0.75rem] [--post-media-bleed-right:0.75rem] [--post-media-content-inset:0.75rem]">
      <button
        type="button"
