...
jest.spyOn(LocalFileStorage.LocalFileStorage, 'getStorage').mockReturnValue(mockLocalStorage as any)
jest.spyOn(S3FileStorage.S3FileStorage, 'getStorage').mockReturnValue(mockS3Storage as any)
  ...
  describe('deleteMediaFile', () => {
    describe('LocalFile storage', () => {
        ...
        it('handles paths with special characters', async () => {
          ...
          expect(mockDeleteFile).toHaveBeenCalledWith('media/file with spaces.jpg')
        })
      })
      ...
      describe('S3Storage', () => {
        ...
        it('handles paths with special characters', async () => {
          ...
          expect(mockDeleteFile).toHaveBeenCalledWith('media/file%20with%20spaces.jpg')
        })
      })
