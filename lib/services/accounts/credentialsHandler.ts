...
// Read handler for the current actor's CredentialAccount, used by
// GET /api/v1/accounts/verify_credentials. (GET /api/v1/profile has its own
// getProfileHandler.) corsHeaders is passed in so the route owns its CORS
// allow-list; verify_credentials uses [OPTIONS, GET].
