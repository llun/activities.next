...
export const PROCESS_FORWARDED_ACTIVITY_JOB_NAME = 'ProcessForwardedActivityJob'
...
export const SEND_FLAG_JOB_NAME = 'SendFlagJob'
...
export const IMPORT_WAHOO_ACTIVITY_JOB_NAME = 'ImportWahooActivityJob'
export const IMPORT_WAHOO_HISTORY_JOB_NAME = 'ImportWahooHistoryJob'
...
export const EMOJI_REACTION_JOB_NAME = 'EmojiReactionJob'
export const FETCH_LINK_PREVIEW_JOB_NAME = 'FetchLinkPreviewJob'
export const FORWARD_ACTIVITY_JOB_NAME = 'ForwardActivityJob'
export const FOLLOW_TIMELINE_BACKFILL_JOB_NAME = 'FollowTimelineBackfillJob'
export const DELIVER_ACTIVITY_JOB_NAME = 'DeliverActivityJob'
