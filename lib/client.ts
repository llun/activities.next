...
// gear editor sends only `defaultSports`) must not have to resend the rest —
// re-sending a stale copy is how a concurrent edit gets silently reverted.
// `kind` is immutable and absent by design.
