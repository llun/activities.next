...
export const PreviewCard = z.object({
  ...
  type: z
    ...
    .describe('The type of the preview card'),

  author_name: z.string().describe('The author of the original resource'),
  author_url: z
    .string()
    .describe('A link to the author of the original resource'),

  provider_name: z.string().describe('The provider of the original resource'),
  provider_url: z
    .string()
    .describe('A link to the provider of the original resource'),
  ...
  embed_url: z
    .string()
    .describe('Used for photo embeds, instead of custom html'),
  blurhash: z
    .string()
    .describe(
