...
const BaseAccount = z.object({
  ...
  username: z
    .string()
    .describe('The username of the actor, not including domain'),
  acct: z
    .string()
    .describe(
  ...
  group: z
    .boolean()
    .describe('Indicates that the actor represents a Group actor'),
  discoverable: z
    .boolean()
    .describe(
  ...
  created_at: z
    .string()
    .describe('The time the actor was created in ISO 8601 Datetime format'),
  last_status_at: z
    .string()
    .describe(
  ...
  statuses_count: z
    .number()
    .describe('How many statuses are attached to this actor'),
  followers_count: z
    .number()
    .describe('The reported followers of this profile'),
  following_count: z.number().describe('The reported follows of this profile')
})
