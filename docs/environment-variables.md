...
| Variable                         | Description                                                                                                                                                                                                                                                                                     |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ACTIVITIES_ALLOW_MEDIA_DOMAINS` | Deprecated compatibility setting. Next image optimization is disabled, remote image patterns are build-time static, and browser image loading is governed by runtime CSP headers. This setting is accepted by the runtime config parser but no longer needs to be provided during `next build`. |
