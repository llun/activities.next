...
- ✅ **List timelines** — Per-list timelines honoring replies policy, exclusive lists, and block/mute/keyword filtering. As in Mastodon, you can add yourself to your own list to see your own posts in it alongside its members' (your 200 most recent posts are backfilled when you do, and an exclusive list never hides your own posts from Home), and direct messages never appear in a list — yours or anyone else's
...
- ✅ **Lists** — Create and manage timeline lists, their members (accounts you follow, plus yourself — `POST /api/v1/lists/:id/accounts` accepts your own account without a follow, and `GET /api/v1/accounts/search?following=true` includes you, as Mastodon's do), replies policy, and exclusive flag
