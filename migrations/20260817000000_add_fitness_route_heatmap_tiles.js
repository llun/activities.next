...
//
// The generation job reads `fitness_file_routes` and writes all three, but
// nothing reads the PYRAMID yet: the serving API and the client's zoom-aware
// fetching land in later changes, so `fitness_route_heatmaps` is untouched and
// keeps serving every heatmap.
